...
\section{Опыт}
    \resumeSubHeadingListStart
        ...
        \begin{mdframed}
\footnotesize\textbf{Стек: Java 8, 11, 17 / Spring: Boot Data, WebFlux, AOP / Apache Maven, Sonatype Nexus / Hibernate, PostgreSQL, CriteriaAPI, MapStruct, Liquibase / Kafka, GraphQL / JUnit, Mockito / BitBucket, Jenkinks CI/CD, SonarQube, OpenShift, WildFly}
\end{mdframed}
        \resumeItemListStart
            \resumeItem{Разрабатывал бэкенд высоконагруженного приложения для сотрудников службы комплаенс банка. Поддерживали существующую платформу - многомодульный maven-проект, по сути "фабрика данных" для нескольких смежных команд. Занимался миграцией легаси монолита на микросервисы. Работали по Agile.}
            ...
            \resumeItem{Упорядочил версионирование артефактов в Nexus, уменьшал тех.долг по SonarQube,  раскатывал новые микросервисы в OpenShift(Kubernetes).}
